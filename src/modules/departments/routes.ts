...
import { departmentListQuerySchema, departmentSchema, updateDepartmentSchema } from './types.js';
...
departmentsRoutes.get('/', requirePermissions('department:read'), validateRequest({ query: departmentListQuerySchema }), asyncHandler(controller.list));
