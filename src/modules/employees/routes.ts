...
import { archiveEmployeeSchema, employeeSchema, updateEmployeeSchema } from './types.js';
...
employeesRoutes.get('/', requirePermissions('employee:read'), validateRequest({ query: listQuerySchema }), asyncHandler(controller.list));
