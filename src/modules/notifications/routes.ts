...
import { notificationListQuerySchema, notificationSchema } from './types.js';
...
notificationsRoutes.get('/', requirePermissions('notification:read'), validateRequest({ query: notificationListQuerySchema }), asyncHandler(controller.list));
